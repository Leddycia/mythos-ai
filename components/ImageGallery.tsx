    ...
    <div className="w-full max-w-7xl mx-auto mt-8 animate-in fade-in zoom-in-95 duration-700">
      ...
      <div className="flex items-center justify-between mb-8 px-2">
        <div>
            ...
            <h2 className="text-2xl md:text-3xl font-bold font-serif text-slate-900 dark:text-white">Galerie Multimédia</h2>
            <p className="text-sm md:text-base text-slate-500 dark:text-slate-400">Vos créations visuelles récentes.</p>
        </div>
      </div>

      {mediaHistory.length === 0 ? (
        <div className="text-center py-20 bg-white/50 dark:bg-slate-900/50 rounded-3xl border border-dashed border-slate-300 dark:border-slate-700 flex flex-col items-center mx-4">
