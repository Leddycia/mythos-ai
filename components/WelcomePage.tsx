  ...
  return (
    <div className="max-w-7xl mx-auto space-y-12 md:space-y-16 pb-20 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="relative text-center space-y-6 py-6 md:py-16">
        {/* Decorative Blobs */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[600px] aspect-square bg-indigo-500/20 dark:bg-indigo-500/10 rounded-full blur-[60px] md:blur-[100px] pointer-events-none"></div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[400px] aspect-square bg-fuchsia-500/20 dark:bg-fuchsia-500/10 rounded-full blur-[40px] md:blur-[80px] pointer-events-none animate-pulse"></div>

        <div className="relative z-10 flex flex-col items-center px-4">
          
          {/* BIG APP TITLE */}
          <h1 className="text-5xl sm:text-6xl md:text-8xl lg:text-9xl font-serif font-black tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 via-fuchsia-500 to-indigo-600 dark:from-indigo-400 dark:via-fuchsia-400 dark:to-indigo-400 animate-in fade-in zoom-in-50 duration-1000 pb-2 drop-shadow-sm leading-tight">
            MythosAI
          </h1>

          <h2 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-serif font-bold tracking-tight text-slate-900 dark:text-white mt-4 md:mt-8 leading-tight">
          ...
          <p className="text-base sm:text-lg md:text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto leading-relaxed mt-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-8 w-full sm:w-auto px-4">
            <Button 
              ...
              variant="secondary"
              className="!py-4 !px-8 text-lg shadow-xl shadow-fuchsia-500/20 w-full sm:w-auto transform hover:scale-105 transition-transform"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative px-4">
         ...
         {[
            { 
              icon: <svg className="w-8 h-8 md:w-10 md:h-10 text-indigo-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" /></svg>,
              title: 'Choisissez un Sujet', 
              desc: 'Histoire, Sciences, ou Culture...' 
            },
            { 
              icon: <svg className="w-8 h-8 md:w-10 md:h-10 text-fuchsia-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" /></svg>,
              title: 'Personnalisez', 
              desc: 'Niveau (Enfant/Adulte), Style, Format...' 
            },
            { 
              icon: <svg className="w-8 h-8 md:w-10 md:h-10 text-emerald-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>,
              title: 'Découvrez', 
              desc: 'L\'IA génère le texte, l\'audio et la vidéo.' 
            }
         ].map((step, idx) => (
            <div key={idx} className="relative z-10 flex flex-col items-center text-center group p-4 bg-white/5 dark:bg-black/5 rounded-2xl md:bg-transparent md:p-0">
                <div className="w-20 h-20 md:w-24 md:h-24 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-lg flex items-center justify-center mb-4 group-hover:-translate-y-2 transition-transform duration-300">
                    {step.icon}
                </div>
      ...
      <div className="space-y-6 px-4">
          <div className="flex items-center justify-between">
            <h2 className="text-2xl md:text-3xl font-serif font-bold text-slate-900 dark:text-white">Fonctionnalités Clés</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 auto-rows-[minmax(200px,auto)]">
              ...
              <div className="md:col-span-2 row-span-1 bg-gradient-to-br from-indigo-600 to-violet-700 rounded-3xl p-6 md:p-8 text-white relative overflow-hidden shadow-xl group min-h-[280px]">
                  ...
                  <div className="relative z-10 flex flex-col h-full justify-between gap-4">
                      <div>
                          ...
                          <h3 className="text-2xl md:text-3xl font-bold mb-2">Génération Multimodale</h3>
                          <p className="text-indigo-100 max-w-md text-sm md:text-base">Ne vous contentez pas de lire. MythosAI génère des illustrations artistiques, des narrations vocales humaines et même des vidéos explicatives.</p>
                      </div>
              ...
              {/* Card - Adaptive */}
              <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 md:p-8 shadow-sm hover:shadow-xl transition-all group">
              ...
              {/* Card - Culture (Ayiti) */}
              <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 md:p-8 shadow-sm hover:shadow-xl transition-all group md:col-span-1">
               ...
               {/* Card - History */}
               <div className="md:col-span-2 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 md:p-8 shadow-sm hover:shadow-lg transition-all flex flex-col md:flex-row items-center justify-between group cursor-pointer text-center md:text-left gap-4" onClick={onViewHistory}>
                  <div>
                  ...
                  <div className="w-12 h-12 rounded-full bg-white dark:bg-slate-700 flex items-center justify-center group-hover:bg-indigo-600 group-hover:text-white transition-colors shadow-sm shrink-0">
